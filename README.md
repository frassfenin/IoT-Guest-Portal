# 🏠 Lokal Standalone Gästportal för Smart Hem-belysning
...
Portalen har ett elegant mörkt glassmorphism-gränssnitt som anpassar sig perfekt för mobiler, vikbara telefoner (som Pixel 10 Pro Fold) och vanliga datorskärmar.
...
2. **⚙️ Inställningshubb & Adminpanel**:
